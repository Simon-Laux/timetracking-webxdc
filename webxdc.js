...
// - moved to top instead of bottom
//===========================================================
...
window.webxdc = (() => {
  ...
  function addXdcPeer() {
    ...
    // get next peer ID
    const params = new URLSearchParams(loc.search.substr(1));
  ...
  window.addEventListener("load", async () => {
    const styleControlPanel =
      "position: fixed; top:1em; left:1em; background-color: #000; opacity:0.8; padding:.5em; font-size:16px; font-family: sans-serif; color:#fff; z-index: 9999";
    const styleMenuLink =
